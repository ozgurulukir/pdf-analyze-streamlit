...
def render_typing_indicator():
    """Render a subtle typing indicator."""
    st.caption("🤖 Belge Analiz Uzmanı düşünüyor...")
    ...
    ">
        ...
        <div>
            ...
            <div style="font-size: 0.78rem; color: #64748b; margin-top: 1px;">
                Model: <span style="color:#a5b4fc">{settings.get('model', 'N/A')}</span> &nbsp;•&nbsp; Bağlam odaklı akıllı analiz
            </div>
        </div>
    </div>
    """,
