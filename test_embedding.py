...
from app.core.models import Workspace, FileMetadata
from app.core.jobs import create_embedding_job, get_job_queue
...
try:
    ...
    for i in range(10):
        ...
        if our_job:
            print(f"Check {i+1}: Status={our_job.status}, Progress={our_job.progress}%")
